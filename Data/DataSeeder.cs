...
namespace EducationCentreSystem.Data
{
    ...
    public static class DataSeeder
    {
        ...
        public static void Seed(IPersonRepository repo, int studentCount, int teacherCount, int adminCount)
        {
            ...
            var firstNames = new[] { "John", "Jane", "Alice", "Bob", "Charlie", "Diana", "Ethan", "Fiona", "George", "Hannah", "Ivan", "Julia", "Kevin", "Laura", "Michael", "Nora", "Oscar", "Paula", "Quinn", "Rachel" };
            ...
            var subjects = new[] { "Math", "Physics", "Chemistry", "Biology", "History", "Geography", "English", "Literature", "Computer Science", "Art" };
            ...
            for (int i = 0; i < studentCount; i++)
            {
                ...
                var s = (Student)PersonFactory.Create(PersonRole.Student);
            ...
            for (int i = 0; i < teacherCount; i++)
            {
                ...
                var t = (Teacher)PersonFactory.Create(PersonRole.Teacher);
                string firstName = firstNames[random.Next(firstNames.Length)];
                string lastName = lastNames[random.Next(lastNames.Length)];
            ...
            for (int i = 0; i < adminCount; i++)
            {
                ...
                var a = (Admin)PersonFactory.Create(PersonRole.Admin);
                string firstName = firstNames[random.Next(firstNames.Length)];
                string lastName = lastNames[random.Next(lastNames.Length)];
